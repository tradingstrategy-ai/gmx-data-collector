...
def test_aggregate_events_to_ohlcv():
    ...
    assert candle1["volume"] == 1500.0  # Sum of size_delta_usd (1000 + 500)
    ...
    assert candle2["volume"] == 200.0  # Sum of size_delta_usd
...
def test_aggregate_identical_timestamps():
    ...
    assert candle["volume"] == 450.0  # Sum (100 + 200 + 150)
